...
const translations = {
    en: {
        ...
        'research.second': 'My current and future work focuses on <strong>Code Agent and GUI Agent</strong>, incorporating <strong>knowledge of software engineering and software testing</strong> to evaluate and build practical, reliable agents for real-world use. My research includes open-ended evaluation of the front-end coding capabilities of models (WebDev and Office), as well as evaluation of User Agents and GUI Agents in realistic usage scenarios.',
    ...
    zh: {
        ...
        'research.title': '研究方向',
        'research.second': '我近期与未来的工作围绕<strong>Code Agent 和 GUI Agent</strong>展开，面向真实使用场景，融入<strong>软件工程与软件测试的知识</strong>，评测与构建实用、可靠的智能体。研究内容包括模型前端（WebDev、Office）Coding 能力的开放式评测；贴合真实使用场景的 User Agent 和 GUI Agent 评测。',
