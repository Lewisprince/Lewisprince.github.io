...
const translations = {
    en: {
        ...
        'pub.subtitle': 'Total citations: 470+',
    ...
    zh: {
        ...
        'research.card3.title': '测试缩减',
        'research.card3.desc': '开发多层状态抽象结合 Delta Debugging 的方法，有效将冗长操作序列缩减为最小故障复现轨迹，大幅降低开发者调试成本。',
